...
extension MarketItem {
    static let mockData: [MarketItem] = [
        MarketItem(
            ...
            quoteType: "FUTURE",
            spark: Sparkline(
                close: [5378.25, 5378.25, 5378, 5378.75, 5379, 5380, 5379.5, 5380, 5377.5, 5374.75, 5376.25],
                timestamp: [1744776300, 1744776600, 1744776900, 1744777200, 1744777500, 1744777800, 1744778100, 1744778400, 1744778700, 1744779000, 1744779300]
            )
        ),
        MarketItem(
            symbol: "^DJI",
            ...
            quoteType: "INDEX",
            spark: Sparkline(
                close: [40427, 40428, 40428, 40429, 40433, 40434, 40436, 40436, 40432, 40410, 40414],
                timestamp: [1744776300, 1744776600, 1744776900, 1744777200, 1744777500, 1744777800, 1744778100, 1744778400, 1744778700, 1744779000, 1744779300]
            )
        ),
        MarketItem(
